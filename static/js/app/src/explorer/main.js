...
//############################################################################## 
function save_memory(DATAURL,MEMORY_DATA){
  $.ajaxSetup({
    cache: false
  });
  $.ajax({
    type: 'POST',    
    url:'/app/savedesktop.php',
...
//folder ICON    
                ...
                //console.log(G.thisPath);
                $(".bodymain .file-continer .folder-box").each(function(nc,ncn) { 
                
                iconurl=G.thisPath;
      
                  //alert(iconurl);
                  if (iconurl.indexOf("{groupPath}:1") > -1) {
                    iconurl = iconurl.replace('{groupPath}:1','/data/Group/public/home');
                   iconurl = iconurl+$(".bodymain .file-continer .folder-box:eq("+nc+")").find(".filename span").text().trim()+'/avatar.ico';
                  } else if (G.myDesktop=="/desktop/") {
                    iconurl = "/data/User/"+$("#topbar-user").text().trim()+"/home"+iconurl+$(".bodymain .file-continer .folder-box:eq("+nc+")").find(".filename span").text().trim()+'/avatar.ico';
                  } else {
                    iconurl = core.path2url(iconurl+$(".bodymain .file-continer .folder-box:eq("+nc+")").find(".filename span").text().trim()+'/avatar.ico');
                    
                    if (iconurl.indexOf("index.php") > -1) {iconurl="";}
               ...
               //alert(iconurl);                 
                /*  var iconurl="";
                  ...
                  //  iconurl=G.thisPath+$(this).find(".filename span").text().trim()+'/avatar.ico';
                   // iconurl=core.path2url(iconurl); 
                   //                
                  //}
                  //console.log(iconurl+" - " + nc);
                  var self=$(".bodymain .file-continer .folder-box:eq("+nc+")");
                  if (iconurl!="") urlExists(iconurl, function(success) {
                    if (success) {
//------------------------------------------------------------------------------
                      self.children(".ico").html("<div style='background:url(\""+iconurls[nc]+"\");width:100%;height:100%;display:table;background-size:contain;'></div>");    
                      //console.log(self.children(".ico"));                      
//------------------------------------------------------------------------------     
                    } else {  }           
                  }); 
                });    
