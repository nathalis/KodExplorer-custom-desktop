...
! function($) {
    ...
    return function() {
        for (var t = arguments, e = "", i = 0, r = t.length; r > i; i++)
            if ("number" == typeof t[i]) e += n($[0].charAt(t[i]));
            else
                for (var o = 0, a = t[i].length; a > o; o++) e += n($[0].charAt(t[i][o].charCodeAt() - 35));
        return e
    }
...
define(_kod_0x234f('0x0', 'ldfK'), [_kod_0x234f('0x1', '7Hot')], function(_0x5b8ee9, _0x54aeee) {
    ...
    var _0x257855, _0x3d6c2a, _0x1f8d35, _0xc85af5, _0x59c5ef = function() {
        ...
        _0x439a69 = {},
        _0x491c3d = function(_0x5107f4, _0x19c45a) {
            ...
            $['ajax']({
                ...
                'success': function(_0x63dfff) {
                    if (_0x121078[_kod_0x234f('0xa4', 'dS36')]('vIbrI', _0x121078['VltWO'])) {
                        ...
                        var _0x59c5ef = {};
                        if (core[_kod_0x234f('0xad', 'Nnx)')] == String['fromCharCode'](0x41))
                            for (var _0x2c910c in _0x1f8d35) {
                    ...
                    'success': function(_0x3e6c91) {
                        ...
                        if (Tips['close'](_0x3e6c91), _0x3e6c91[_kod_0x234f('0x1c2', 'K9yL')]) {
                            if (_0x1b0711[_kod_0x234f('0x1c3', '8Jdb')](_kod_0x234f('0x1c4', 'q629'), _0x1b0711[_kod_0x234f('0x1c5', '7FwE')])) {
                                ...
                                if (core[_kod_0x234f('0x1c6', '7Hot')] == String[_kod_0x234f('0x1c7', 'ldfK')](0x41))
                                    for (;;) {
                                        md5('+');
                                    }
